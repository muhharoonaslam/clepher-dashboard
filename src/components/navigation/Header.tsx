...
const HeaderLayout: React.FC = () => {
  return (
    <header className="flex justify-between items-center px-6 py-2 bg-white shadow-md relative z-20">
      ...
      <div className="flex items-center space-x-6 relative">
        ...
        <div className="relative group">
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition duration-200 z-50 invisible group-hover:visible group-hover:flex flex-col">
            <Link
              to="/home"
